    ...
    <div class="content">
      <div class="article">
        <div class="breadcrumb">
          <dl>
            <dt>当前位置：</dt>
            <dd><a href="javascript:;"><?php echo $detailArr[0]['name']?></a></dd>
            <dd><?php echo $detailArr[0]['title']?></dd>
          </dl>
        </div>
        <h2 class="title">
        ...
        <div class="meta">
          <span><?php echo $detailArr[0]['nickname']?> 发布于 <?php echo $detailArr[0]['created']?></span>
          <span>分类: <a href="javascript:;"><?php echo $detailArr[0]['name']?></a></span>
          <span>阅读: (<?php echo $detailArr[0]['views']?>)</span>
          <span>点赞: (<?php echo $detailArr[0]['likes']?>)</span>
        </div>
        <div class="content-detail"><?php echo $detailArr[0]['content']?></div>
